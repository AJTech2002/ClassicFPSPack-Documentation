...
Note that there are **_2_** capsules overlapping, the top most capsule is the Capsule Collider, note that it is around half the height of the Character Controller and the radius is slightly larger than the Character Controller.
